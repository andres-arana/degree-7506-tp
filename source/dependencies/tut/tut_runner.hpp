...
public:
    ...
    void run_tests_not_starting_with(const std::string &start_stem) const {
        cb_run_started_();
    ...
    void run_tests_starting_with(const std::string &start_stem) const {
        cb_run_started_();
